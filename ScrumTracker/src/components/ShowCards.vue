<template>
  <div class= "row justify-around items-start ">
    <div v-for="(card, index) in projectCards" v-bind:key="index" class="col-sm-6 col-md-4 q-pa-sm">
    ...
    <q-dialog v-model="editCardData">
      <q-card class="q-pa-md" style="width: 80vh">
        ...
        <CardsForm :allCards="allCards" :newCard="editCards" :editCard="true" :editCardId="editCardId" @submitCard="updateCardInfo()"></CardsForm>
      </q-card>
    </q-dialog>
